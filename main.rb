...
startingPosition = Position.new board_dsl
startingPosition.show_image

temp_possible_moves = Step.getPossibleMoves(startingPosition)

on :key_down do
  next_possible_move = temp_possible_moves.shift
  if next_possible_move
    next_possible_move.show_image
  else
    close
  end
end
